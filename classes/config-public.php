...
class configPublic
{
    const INSTITUTIONNAME = 'Balboa Public Library'; /* e.g.:  Balboa University Library */
    const DB = 'sierra-public.iii.com';
    const PACSERVER = 'encore-public.iii.com';
    const IRSERVER = '/encorecalstate.iii.com';
    const APIVER = '3';
    const APIKEY = 'u/h2DXu811Qut62JpnpmnWkWELMr';
    const APISECRET = 'shimshock';
